            ...
            <div class="container" style="height: 100%;min-height: 100%;max-height: 100%;">
                <div class="row">
                    ...
                    <div class="col-auto d-xl-flex" style="width: 100%;">
                        <h2 class="text-left">Ganador del partido:&nbsp;<?php echo$partido['ganador']; ?></h2>
                        <h2 class="d-xl-flex" style="margin-left: 35%;">Jugado el <?php echo$partido['fecha']; ?></h2>
                    </div>
                </div>
                <div class="row" style="min-height: 20%;max-height: 20%;margin-bottom: 2%;padding: 2%;margin-top: 2%;">
                    ...
                    <div class="col">
                        <h2 class="text-center d-xl-flex justify-content-xl-center" style="padding-top: 2%;padding-bottom: 2%;"><?php echo$partido['equipo2']; ?></h2>
                    </div>
                </div>
                ...
                <div class="row" style="height: 50%;max-height: 50%;min-height: 50%;margin-top: 1%;color: #c6d7f1;">
                    ...
                    <div class="col" style="background-image: url(&quot;../../assets/<?php echo$mapas[1]['ruta_imagen'];?>&quot;);background-size: 100%;background-repeat: no-repeat;opacity: 0.85;">
                        <h2><?php echo$partido['mapa2']; ?></h2>
                        <h3 style="margin-bottom: 30%;">Ganador: <?php echo$partido['ganador2']; ?></h3>
                    </div>
                    <div class="col-md-4" style="background-image: url(&quot;../../assets/<?php echo$mapas[2]['ruta_imagen'];?>&quot;);background-size: 100%;background-repeat: no-repeat;opacity: 0.81;">
